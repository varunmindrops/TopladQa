                     ...
                     <div class="course_indetails row">
                        <div class="wrap_tab_oput">
                           <div class="single_pinfo my-1">
                              ...
                              <div class="my-4">
                                 <h4 class="mb-10 mt-2 pt-0 f-26">Eligibility for Admission</h4>
                                 <p class="f-p">
                              ...
                              <div class="my-4">
                                 ...
                                 <ol>
                                    @foreach($cs_executive_2 as $level)
                              ...
                              <div class="my-4">
                                 ...
                                 <h4 class="mb-10 mt-2 pt-0 f-26">Passing Criteria</h4>
                                 <p class="f-p">
