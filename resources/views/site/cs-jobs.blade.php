...
@prepend('head-data')
<title>CS Jobs | Company Secretary Openings | Toplad</title>
<meta name="description" content="Find the right job only for Company Secretary Openings students which job match with your expectations. Toplad help you in searching good jobs for you.">
<meta name="keywords" content="Company Secretary, CS, CS Jobs, CS Candidates, Find Job, Job Search, Hire Employees, Opening for CS, Recruitment for CS, CS Employees, CS in Future, Company Secretary Openings Jobs, Hiring for Company Secretary, Get Job Company Secretary, Job Search for Company Secretary, Company Secretary Students, Company Secretary Employees" />
@endprepend
        ...
        <section class="career_section">
            <div class="container">
                <div class="job_headings">
                    ...
                    @endphp
                    @endforeach
                    <h1 class="job_content_tiles">Latest CS Jobs ({{$jobCount}})</h1>
                            ...
                            <div class="wrap_careers">
                                <div class="career_accord">
                                    ...
                                    <div class="card">
                                        ...
                                        <a class="jd_links" href="{{ url('/cs/job-opening/'.$newPosting.'-'.$newOrganization.'/'.$job['id']) }}">
