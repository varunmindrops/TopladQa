...
@prepend('head-data')
<title>Best CMA Online Classes in India | CMA Capsule Revision Online Classes</title>
<meta name="description"
    content="Learn best CMA online classes from India's top CMA faculty at Toplad. We are dedicated to CMA capsule revision online classes for anyone, anywhere and anytime in India.">
<meta name="keywords"
            ...
            <div class="container">
                <div class="ftco-animate intro_headd">
                    <div class="big_top_block">
                        <h1 class="pt-0 f-34 big_data"><b>CMA June/December 2022 Exams Capsule classes</b>: Complete Exam Revision
                            in less than 10 hours
                        </h1>
                        <p class="text-center">For all subjects and papers from Top CMA Faculty in India.</p>
                        ...
                        <p>Buy Objective and descriptive  based Capsule classes for all the subjects from Foundation/Inter/Final from best faculty under one roof. 
                            Complete Objective and descriptive  based exam preparation in less than 10 hours at your comfort.</p>
        ...
        <div class="middle_cap_carder common_cap_carder">
            <div class="container">
                <div class="big_main" id="main_points">
                    <h3 class="list_title">OBJECTIVE AND DESCRIPTIVE BASED CLASSES.</h3>
                    <ul>
                        ...
                        <li><span class="bg_checker"><img class="bullet_img"
                                ...
                                class="checker_content"><b>CMA Capsules</b> are meant for <b>100% Exam Oriented
                                    Preparation</b>.</span>
                        </li>
                        <li><span class="bg_checker"><img class="bullet_img"
                                    src="{{ asset('images/icon/checkmark.svg') }}" alt="Bullet Image"><i
        ...
        <div class="stripd_info" id="">
            <div class="container">
                <div class="inner_striped">
                    <h3>For All Subjects from top CMA Faculty in India</h3>
                </div>
            </div>
        </div>
                ...
                <div class="panel-group custom_pancc" id="accordionFAQ">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordionFAQ" href="#collapse1">
                                    <span class="acc_mdata">What are CMA Capsule Classes?
                                    </span><i class="fa fa-plus"></i></a>
                            </h4>
                        </div>
                        <div id="collapse1" class="panel-collapse collapse show">
                            <div class="panel-body"><b>CMA capsule classes</b> are pre- recorded summary lectures which
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapse3" class="panel-collapse collapse">
                            <div class="panel-body">Click on the desired CMA Capsule class you want to purchase and
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordionFAQ" href="#collapse4">
                                    <span class="acc_mdata">Which all CMA papers are offered in CMA Capsule Classes?

                                    </span><i class="fa fa-plus"></i></a>
                            </h4>
                        </div>
                        <div id="collapse4" class="panel-collapse collapse">
                            <div class="panel-body">We offered all 20 papers of the CMA course in capsule Classes. You
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordionFAQ" href="#collapse6">
                                    <span class="acc_mdata">How to purchase a CMA Capsule Classes at Toplad?
                                    </span><i class="fa fa-plus"></i></a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordionFAQ" href="#collapse7">
                                    <span class="acc_mdata">For which session CMA Capsule class are available? </span><i
                                        class="fa fa-plus"></i></a>
                            </h4>
                        </div>
                        <div id="collapse7" class="panel-collapse collapse">
                            <div class="panel-body">Rightnow, CMA Capsule class are available for the session June/December 2022 Exams attempt. </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordionFAQ" href="#collapse10">
                                    <span class="acc_mdata">When I purchased the CMA capsule classes, they didn't ask
...
$("#share").jsSocials({
    showLabel: false,
    showCount: false,
    shareUrl: "https://toplad.in/cma/capsule-revision-cma",
    shareIn: "popup",
    title: true,
    media: true,
    ...
    shares: [
        ...
        {
            share: "twitter",
            url: "https://toplad.in/cma/capsule-revision-cma",
            text: "CMA Capsule Revision Online Classes | June/December 2022 Exams"
        },
        {
            share: "facebook",
            url: "https://toplad.in/cma/capsule-revision-cma",
