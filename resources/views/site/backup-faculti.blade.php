...
<div class="inner_theme_page inner_header_page faculty_theme p-b30">
    ...
    <section class=" faclt-prof">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 ftco-animate p-b20">
            ...
            <div class="side__bar">
                                    ...
                                    <div class="details p-10 text-left update_content wrap_main_info">
                                        <div class="course_info">
                                            ...
                                            <div class="fromate-provide">
                                                <img class="supported_img" src="{{ asset('images/icon/book_f2.svg') }}" alt="Format">
                                                @if($teacher->hard_book_id)

                                                <img class="supported_img" src="{{ asset('images/icon/pdf_f2.svg') }}" alt="Format">
                                                @endif
                                                @if($teacher->e_book_id)
                                                <img class="supported_img" src="{{ asset('images/icon/usb_f.svg') }}" alt="Format">
                                                @endif
                                                @if($teacher->video_id)
                                                <img class="supported_img" src="{{ asset('images/icon/vid_f2.svg') }}" alt="Format">
                                                @endif
                                            </div>
                                        </div>
                ...
                <div class="row bottom_cinfos">
                    ...
                    @if(!empty($course[0]->paper_syllabus))
                        <div class="col-md-12 col-sm-12 com_bdivs" id="sylbsdiv">
