...
@prepend('head-data')
<title>CMA Jobs | Certified Management Accountant Openings | Toplad</title>
<meta name="description" content="Find the right job only for Certified Management Accountant students which job match with your expectations. Toplad help you in searching good jobs for you.">
<meta name="keywords" content="Certified Management Accountant, CMA, CMA Jobs, CMA Candidates, Find Job, Job Search, Hire Employees, Opening for CMA, Recruitment for CMA, CMA Employees, CMA in Future, Certified Management Accountant Jobs, Hiring for Certified Management Accountant, Get Job Certified Management Accountant, Job Search for Certified Management Accountant, Certified Management Accountant Students, Certified Management Accountant Employees" />
@endprepend
        ...
        <section class="career_section">
            <div class="container">
                <div class="job_headings">
                    ...
                    @endphp
                    @endforeach
                    <h1 class="job_content_tiles">Latest CMA Jobs ({{$jobCount}})</h1>
                            ...
                            <div class="wrap_careers">
                                <div class="career_accord">
                                    ...
                                    <div class="card">
                                        ...
                                        <a class="jd_links" href="{{ url('/cma/job-opening/'.$newPosting.'-'.$newOrganization.'/'.$job['id']) }}">
