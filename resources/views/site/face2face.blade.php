...
@prepend('head-data')
<title>CMA Face to Face Classes | CMA | Toplad</title>
...
<meta name="keywords" content="CMA, CMA courses online, Foundation to Final, Top Faculty of India, Academy of Excellence, CMA in Future, CMA Books, Online CMA Classes" />
@endprepend
        ...
        <div class="wrap_f2fimg">
            <div class="container">
                ...
                <div class="f2f_block">
                        ...
                        <img src="{{ asset('images/f2f_detail_mobile1.png') }}" alt="F2F Details" class="img-responsive ftf_mob">
        ...
        <div class="wrap_f2fimg bg-gray">
            <div class="container">
                <div class="f2f_block">
                        ...
                        <img src="{{ asset('images/f2f_detail_mobile2.png') }}" alt="F2F Details" class="img-responsive ftf_mob">
        ...
        <div class="wrap_f2fimg">
            <div class="container">
                <div class="f2f_block">
                        ...
                        <img src="{{ asset('images/f2f_detail_mobile3.png') }}" alt="F2F Details" class="img-responsive ftf_mob">
