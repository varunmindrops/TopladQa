    ...
    <div class="wrap_tab_contents">
        <div class="container-fluid">
            <div class="card_info shadow_blk">
                ...
                <h4 class="font-italic mb-2">Manage Pending Job Posts</h4>

                <div class="col-lg-12 post_table">
                    <div class="table-responsive super_table">

                        <form type="GET" action="/admin-login/pending-job-post">
                ...
                <div class="modal fade ful_wid_modes" id="crud-modal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="post_form" action="/admin-login/pending-job-post" method="POST" autocomplete="off" enctype="multipart/form-data">
                                <div class="modal-body">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.view-post', function() {
            ...
            $.get('pending-job-post/' + post_id, function(data) {
                if (data.length > 0) {
                let strDetail = ``;
        ...
        $(document).on('click', '.delete-post', function() {
            ...
            if (choice) {
                $.ajax({
                    type: "DELETE",
                    url: "/admin-login/pending-job-post/" + post_id,
                    data: {
                        "id": post_id,
                        "_token": token,
                    },
        ...
        $(document).on('click', '.edit-post', function() {
            var post_id = $(this).data('id');
            $.get('pending-job-post/' + post_id + '/edit', function(data) {
