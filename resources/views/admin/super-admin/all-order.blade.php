        ...
        <div class="container-fluid">
            ...
            <div class="board_cards">
                <div class="wrap_cards">
                    <div class="min_bcards mcards1">
                        <div class="icon_slot">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                        </div>
                        <div class="order_details_bcard">
                            <h3>All Orders</h3>
                            <p>{{$all}}</p>
                        </div>
                    </div>
                    <div class="min_bcards mcards2">
                        <div class="icon_slot">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                        </div>
                        <div class="order_details_bcard">
            ...
            <div class="card_info shadow_blk">
                ...
                <div class="col-lg-12 order_table">
                    <div class="table-responsive super_table">
                        ...
                        <form type="GET" action="/fulfilment/order">
...
<div>`
                                ...
                                "rtp" || item.product_type == "past papers" || item
                                .product_type == "combo") {
