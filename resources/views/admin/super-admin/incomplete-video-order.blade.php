        ...
        <div class="wrap_tab_contents">
            <div class="container-fluid">
                <div class="card_info shadow_blk">
                                    ...
                                    <tbody>
                                        @foreach ($data as $order)
                                            <tr>
                                                ...
                                                <td><button title="View" type="submit"
                                                        class="table_btn edit_linker view-order" data-toggle="modal"
                                                        data-id="{{ $order['id'] }}"><span><i class="fa fa-eye"
                                                                aria-hidden="true"></i></span></button>
                                                    <meta name="csrf-token" content="{{ csrf_token() }}">
                                                    
                                                    @if ($order['deliver_status'] == 0)
                                                        <button title="Add" type="submit"
                                                            class="table_btn edit_linker add-order" data-toggle="modal"
                                                            data-id="{{ $order['id'] }}"><span><i class="fa fa-plus"
                                                                    aria-hidden="true"></i></span></button>
                                                        <button title="Not Delivered"
                                                            class="table_btn edit_linker off_switch unapproved_button"
                                                            data-id="{{ $order['id'] }}"
                                                            data-status="{{ $order['deliver_status'] }}"
                                                            data-type="complete"
                                                            data-confirm="Are you sure this order is delivered?"
                                                            type="button"><span><i class="fa fa-toggle-off"
                                                                    aria-hidden="true"></i></span></button>
                                                    @elseif($order['deliver_status'] == 1)
                                                        <button title="Delivered"
                                                            class="table_btn edit_linker on_switch approved_button"
                                                            data-id="{{ $order['id'] }}"
                                                            data-status="{{ $order['deliver_status'] }}"
                                                            type="button"><span><i class="fa fa-toggle-on"
                                                                    aria-hidden="true"></i></span></button>
                                                    @endif

                                                    @if ($order['book_deliver_status'] == 0)
                                                        <button title="Book Not Delivered"
                                                            class="off_switch unapproved_button change_button"
                                                            data-id="{{ $order['id'] }}"
                                                            data-status="{{ $order['book_deliver_status'] }}"
                                                            data-type="book"
                                                            data-confirm="Are you sure Books are delivered?"
                                                            type="button"><span><i
                                                                    class="fa fa-book"></i></span></button>
                                                    @elseif($order['book_deliver_status'] == 1)
                                                        <button title="Book Delivered"
                                                            class="on_switch approved_button change_button change_button_green"
                                                            data-id="{{ $order['id'] }}"
                                                            data-status="{{ $order['book_deliver_status'] }}"
                                                            type="button"><span><i
                                                                    class="fa fa-book"></i></span></button>
                                                    ...
                                                    @if ($order['video_deliver_status'] == 0)
                                                        <button title="Video Not Delivered"
                                                            class="off_switch unapproved_button change_button change_margin"
                                                            data-id="{{ $order['id'] }}"
                                                            data-status="{{ $order['video_deliver_status'] }}"
                                                            data-type="video"
                                                            data-confirm="Are you sure this Videos are delivered?"
                                                            type="button"><span><i
                                                                    class="fa fa-youtube-play"></i></span></button>
                                                    @elseif($order['video_deliver_status'] == 1)
                                                        <button title="Video Delivered"
                                                            class="on_switch approved_button change_button change_button_green change_margin"
                                                            data-id="{{ $order['id'] }}"
                                                            data-status="{{ $order['video_deliver_status'] }}"
                                                            type="button"><span><i
                                                                    class="fa fa-youtube-play"></i></span></button>
                                    ...
                                    <div class="tab">
                                        <div class="row modal_row_data tab-one">
                                            ...
                                            <div class="col-sm-4 col_inputs">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Razorpay Order Id"
                                                        class="form-control" disabled id="rzp_order_id">
                                                </div>
                                            </div>
                                            <div class="col-sm-4 col_inputs">
                                                <div class="form-group">
                                                    <label>Other Payment Id</label>
                                                    <input type="text" placeholder="Other Payment Id" class="form-control"
                                                        disabled id="payment_id">
                                                </div>
                                            </div>
                                            <div class="col-sm-4 col_inputs">
                                                <div class="form-group">
                                        ...
                                        <div class="row modal_row_data tab-two">
                                            ...
                                            <div class="col-sm-6 col_inputs">
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <input type="text" placeholder="Address" class="form-control" disabled
                                                        id="user_address">
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col_inputs">
                                                <div class="form-group">
                                                    <label>State</label>
                                                    <input type="text" placeholder="State" class="form-control" disabled
                                                        id="user_state">
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col_inputs">
                                                <div class="form-group">
                                                    <label>Pincode</label>
                                                    <input type="text" placeholder="Pincode" class="form-control" disabled
                                                        id="user_pin">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row modal_row_data tab-four">
                                            ...
                                            <div class="col-sm-4 col_inputs" id="other" style="display: none;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Other Payment Mode"
                                                        class="form-control" disabled id="other_payment">
                                                </div>
                                            </div>
                                            <div class="col-sm-4 col_inputs">
                                                <div class="form-group">
                    ...
                    <!-- Add Order Modal -->
                    <div class="modal fade same_model_data" id="crud-modal" aria-hidden="true" data-backdrop="static"
                        data-keyboard="false">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="orderCrudModal"></h4> <button type="button"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="details" id="details" class="form-control @error('details') is-invalid @enderror" rows="6"
...
<div>`
        ...
        if (choice) {
            $.ajax({
                type: "PUT",
                url: "/fulfilment/incompleted-video-order/" + order_id,
                data: {
                    "id": order_id,
                    "status": status == 1 ? 0 : 1,
                    "type":type,
