                        ...
                        <div class="wrap_fcontent">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="confirm-password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Confirm your password">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group btn_fgroup">
                                ...
                                <p class="link_text">Alreaty have an Account</p> <a href="/login" class="ancher_link">Sign-in</a></p></div>
                            </div>
                        </div>
                    </form>
                </div>
