        ...
        <div class="invoice_print">
                    ...
                    <table class="table">
                        ...
                        @foreach($details as $detail)
                            <tr>
                                ...
                                <td>{{$detail['videoDeliveryType']['name']}}</td>
                                <td>{{$detail['bookDeliveryType']['name']}}</td>
                                <td>{{$detail['mstAttempt']['name']}}</td>
            ...
            <div class="invoice_title">
                <ul class="invoice_pricer">
                    <li><span class="price_name">Subtotal</span> <span class="amount_view"><i class="fa fa-rupee"></i> Rs. {{ $details->sum('price') }}</span></li>
                    <li><span class="price_name">Shipping</span> <span class="amount_view"><i class="fa fa-rupee"></i> Rs. 250</span></li>
                    <li class="final_amount"><span class="price_name">Total</span> <span class="amount_view"><i class="fa fa-rupee"></i> Rs. {{ $details->sum('price') + 250 }}</span></li>
                </ul>
            </div>
        </div>
    </div>
