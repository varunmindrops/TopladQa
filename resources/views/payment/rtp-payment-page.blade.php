...
<head>
    ...
    <title>Buy Revision Test Paper | From November 2019 till January 2021</title>
...
options.modal = {
		ondismiss: function() {
            location.href="/{{$segment}}/{{$segment}}-rtp-sale";
		},
...
<form action="/{{$segment}}/payment/complete-rtp-order" method="POST" hidden>
    @csrf
