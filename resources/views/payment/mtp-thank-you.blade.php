        ...
        <div class="container">
            <div class="row justify-content-md-center">
                ...
                <div class="order-box text-center">
                    ...
                    <h3>Thank You</h3>
                    @if($name == "cma")
                        <p>We will be sending Mock Test Paper Google link on email within 48 Hours.</p>
                    @elseif($name == "ca")
                        <p>We will be sending Revision Test Paper Google link on email within 48 Hours.</p>
                    @endif
