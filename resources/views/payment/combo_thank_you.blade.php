@php $mode = session()->get( 'mode' ); @endphp
        ...
        <div class="container">
            <div class="row justify-content-md-center">
                ...
                <div class="order-box text-center">
                    ...
                    <p>We will be sending the Combo Class {{ $mode }} on email within 48 Hours.</p>
                    @elseif($mode == "Pen Drive")
                    <p>We will be dispatching Combo Class {{ $mode }} within 48 Hours.</p>
                    @endif
