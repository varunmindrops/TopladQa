...
<form action="/payment/pay-us-now" method="POST" hidden>
    @csrf
    ...
    <input type="text" class="form-control" name="phone" id="phone" value="{{ $response['contactNumber'] }}">
    <input type="text" class="form-control" name="amount" id="amount" value="{{ $response['amount'] }}">
