...
<head>
    ...
    <title>Buy Mock Test Paper | From June 2017 till June 2022</title>
...
options.modal = {
		ondismiss: function() {
            location.href="/{{$segment}}/{{$segment}}-mtp-sale";
		},
...
<form action="/{{$segment}}/payment/complete-mtp-order" method="POST" hidden>
    @csrf
