...
<head>
    ...
    <title>Buy Capsule Classes | Re-Exam January 2021 Exam</title>
...
options.modal = {
		ondismiss: function() {
            location.href="/{{$segment}}/capsule-revision-{{$segment}}";
		},
...
<form action="/{{$segment}}/payment/complete" method="POST" hidden>
    @csrf
