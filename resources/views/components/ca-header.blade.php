...
<nav class="navbar navbar-expand-lg home_header site_header">
    <div class="container">
        <!-- <a class="navbar-brand" href="/ca"><img src="{{ asset('images/ra-logo/ca-toplad-logo.svg') }}"
        ...
        <div class="collapse navbar-collapse">
            <div class="navbar-nav ml-auto menu site_menu" id="main_menu">
                ...
                <ul class="main_navui">
                    ...
                    <li><a class="top_nav_link" href="/{{ $segment }}/ca-combo-offer-exam-classes">Combo
                            Videos</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/ca-past-papers">Past Papers Videos</a>
                    </li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/ca-rtp-sale">RTP Videos</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/demo-videos">Demo Videos</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/ca-combo-offer">Combo Offer</a></li>
                    ...
                    <li class="login_pane_mobile">
                        @if (Auth::check())
                            ...
                            document.getElementById('layout-logout-form-mob').submit();">Logout</a>
                                ...
                                @endif
                                @if (Auth::user()->role == 'order-fulfilment-order')
                                    <li class="">
                                        <a class="top_nav_link" title="Order Fulfilment Team Profile"
                                            href="/fulfilment/order"> Order Fulfilment Team Profile</a>
                                    </li>
