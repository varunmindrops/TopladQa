...
<nav class="navbar navbar-expand-lg home_header site_header">
    <div class="container">
        <!-- <a class="navbar-brand" href="/cma">
            <img src="{{ asset('images/ra-logo/cma-toplad-logo.svg') }}" class="img-responsive" alt="cma-toplad-logo"/>
        </a> -->
...
<nav class="navbar navbar-expand-lg home_header product_header opacity-background-download">
    <div class="container">
        ...
        <div class="logo_wraped">
            <a class="navbar-brand" href="/cma"><img src="{{ asset('images/ra-logo/cma-toplad-logo.svg') }}"
                    class="img-responsive" alt="cma-toplad-logo" /></a>
        ...
        <div class="collapse navbar-collapse">
            <div class="navbar-nav ml-auto menu site_menu" id="main_menu">
                ...
                <ul class="main_navui">
                    ...
                    <li><a class="top_nav_link" href="/{{ $segment }}/capsule-revision-cma">Capsule Videos</a>
                    </li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/cma-combo-offer-classes">Combo
                            Videos</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/cma-past-papers">Past Papers Videos</a>
                    </li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/cma-mtp-sale">MTP Videos</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/cma-chapter-sale">Chapter Wise Videos</a>
                    </li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/demo-videos">Demo Videos</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/cma-combo-offer">Combo Offer</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/downloads-notes">Downloads</a></li>
                    <li><a class="top_nav_link" href="/{{ $segment }}/cma-books">Books</a></li>
