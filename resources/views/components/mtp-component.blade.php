<table id="" class="table table-striped table-bordered">
    ...
    @foreach($mst_course_level as $course_level)
        ...
        @foreach($course_level['mst_paper_subject'] as $subject)
            ...
            @endphp
            <form action="/pay-now" method="POST" class="mtp_form" id="form_{{ $subject['id'] }}">
                @csrf
                ...
                <td class="tec_select select_teche"><span class="moblie_crash">Faculty</span>
                    ...
                    @foreach($subject['mtp_product'] as $faculty)
                        <option value="{{ $faculty['user']['id'] }}">{{ $faculty['user']['name'] }}</option>
                    @endforeach
                    </select>
                </td>

                @foreach($subject['mtp_product'] as $product)
                ...
                <input type="hidden" class="form-control" name="product_type" value="MTP" required>
