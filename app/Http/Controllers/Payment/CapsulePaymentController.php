...
class CapsulePaymentController extends Controller
{
    private $razorpayId;
    private $razorpayKey;
    ...
    public function store(Request $request, $segment)
    {
        ...
        return view('payment.capsule-payment-page', compact('response', 'subject', 'faculty', 'segment'));
    }
    ...
    public function Complete(Request $request, $segment)
    {
        ...
        if ($signatureStatus == true) {
            ...
            return redirect('/' . $segment . '/payment-fail');
        }
    }
