...
class PastPaperPaymentController extends Controller
{
    private $razorpayId;
    private $razorpayKey;
    ...
    public function store(Request $request, $segment)
    {
        ...
        return view('payment.past-papers-payment-page', compact('response', 'subject', 'faculty', 'segment'));
    }
    ...
    public function Complete(Request $request, $segment)
    {
        ...
        if ($signatureStatus == true) {
            ...
            return redirect('/'.$segment.'/order-fail');
        }
    }
