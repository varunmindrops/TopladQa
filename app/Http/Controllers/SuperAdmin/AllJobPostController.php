...
class AllJobPostController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->search != "") {
            ...
            $data = JobPost::with('mstCourse')->whereNull('deleted_at')->orderBy('created_at', 'DESC')->paginate(10);
        }

        return view('admin.super-admin.all-job-post', compact('data'));
    }
