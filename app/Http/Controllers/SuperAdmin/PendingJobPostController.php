...
class PendingJobPostController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->search != "") {
            ...
            $data = JobPost::with('mstCourse')->whereNull('deleted_at')->where('status', 'pending')->orderBy('created_at', 'DESC')->paginate(10);
        }
        return view('admin.super-admin.pending-job-post', compact('data'));
    }
