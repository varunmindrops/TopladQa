...
class RejectedJobPostController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        if ($request->search != "") {
            ...
            $data = JobPost::with('mstCourse')->whereNull('deleted_at')->where('status', 'rejected')->orderBy('created_at', 'DESC')->paginate(10);
        }
        return view('admin.super-admin.rejected-job-post', compact('data'));
    }
